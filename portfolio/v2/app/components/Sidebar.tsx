...
const Sidebar = () => {
  ...
  return (
    <aside className="lg:fixed p-6 lg:flex lg:flex-col justify-between lg:left-0 lg:top-0 lg:h-full lg:w-[48%] lg:p-20">
      {/* Header Section */}
      <motion.div
          ...
          {["About", "Experience", "Projects"].map((item, index) => {
            ...
            return (
              ...
              >
                <Link
                  href={`#${sectionId}`}
                  className={`text-lg text-white flex items-center group transition duration-300 ${
                    isActive ? "active" : ""
                  }`}
                >
                  {/* Animated Indicator */}
