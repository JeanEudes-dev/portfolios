...
const Experience = () => {
  ...
  const experienceData = [
    {
      period: experiences[0]?.period || "02/2024 — Present",
      title: experiences[0]?.title || "Founder & Lead Engineer",
      company: experiences[0]?.company || "BrollyHub",
      link: "https://platform.brollyhub.com",
    ...
    {
      period: experiences[1]?.period || "02/2024 — 08/2024",
      title: experiences[1]?.title || "AI Engineer",
      company: experiences[1]?.company || "RenoSmarter.ai",
    ...
    {
      period: experiences[2]?.period || "06/2023 — Present",
      title: experiences[2]?.title || "Frontend Developer & Web Architect",
      company: experiences[2]?.company || "Rauf Denktas University",
    ...
    {
      period: experiences[3]?.period || "01/2021 — Present",
      title: experiences[3]?.title || "Freelance Full-Stack Developer",
      company: experiences[3]?.company || "Independent Contractor",
